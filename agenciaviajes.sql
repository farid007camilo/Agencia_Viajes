...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 02-06-2022 a las 02:31:22
...
(1, 'prueba', 'prueba@prueba.com', 'texto de prueba para la base de datos'),
(2, 'prueba-1', 'prueba@prueba.com', 'texto de prueba para la base de datos otra cosa'),
(3, 'farid', 'farid@correo.com', 'las mejore vacaciones '),
(4, 'jhon doe', 'jhon.doe@correo.com', 'fueron las mejores vacaciones de mi vida, la atencion ele hotel el servicio a la habitacion todo me parecio de maravilla es lo mejor GRACIAS');
